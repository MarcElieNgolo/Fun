...
export default function Acceuil() {
    ...
    const headerBackgroundImage:string = window.innerWidth > 768 ? "/fond_ecran_paysage.jpg":"/fond_ecran_portrait.png"
    ...
    return (
        <div className="Acceuil">
            ...
            {/* Section Header améliorée avec image de fond et overlay */}
            <header
            ...
            >
                ...
                {/* Contenu du header */}
                <div className="relative container mx-auto px-8 mt-8 z-10 text-center">
                    <h1 className="text-4xl md:text-7xl font-extrabold mb-4 leading-tight drop-shadow-lg animate-fade-in-down">
                        BATI-PRO-INGENIERIE
                    </h1>
                    <p className="text-xl md:text-2xl opacity-90 max-w-3xl mx-auto mb-8 animate-fade-in-up">
                        Votre partenaire d'excellence en Architecture, Ingénierie et Construction Durable en Côte d'Ivoire.
                    </p>
                    <a
                        href="#contact"
                        className="mt-10 inline-block bg-white text-orange-600 hover:bg-orange-100 font-bold py-4 px-10 rounded-full text-lg shadow-xl transition duration-300 transform hover:scale-105 animate-bounce-in"
                    >
                ...
                <div className="container mx-auto px-8">
                    ...
                    <a
                        ...
                        className="inline-block bg-orange-600 hover:bg-orange-700 text-white font-bold py-5 px-14 rounded-full text-xl shadow-lg hover:shadow-xl
                                   transition duration-300 transform hover:-translate-y-1 active:opacity-75"
                    >
